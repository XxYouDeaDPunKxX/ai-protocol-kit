...
| [Output for Real Readers Protocol v2](protocols/output-for-real-readers-protocol-v2.md) 🗣️ | Use when asking AI to write guides, README text, emails, pages, forms, instructions, or other reader-facing material, forcing reader, purpose, tone, constraints, and language to close before it writes in the wrong voice. |
